...
urlpatterns = [
    ...
    path('api/tasks/stream', views.task_events_stream, name='task_events_stream'),
    path('api/tasks/<uuid:task_id>/report', views.report_task, name='report_task'),
    path('api/executors/report', views.executor_report, name='executor_report'),
    ...
    path('api/admin/executors', views.admin_executors, name='admin_executors'),
    path('api/admin/executors/stream', views.admin_executors_stream, name='admin_executors_stream'),
