...
export type ExecutorStatus = 'idle' | 'running' | 'offline'
...
export interface GetExecutorsResp {
  items: ExecutorItem[]
...
export type UpdateRuntimeConfigReq = RuntimeConfig
...
export type UpdateToolVersionStatusResp = ToolVersionItem
