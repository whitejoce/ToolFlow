...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      ...
      statusReportInterval: cfg.server.status_report_interval ?? 5,
    ...
    try {
      ...
      saveMutation.mutate({
        ...
        server: {
          ...
          status_report_interval: values.statusReportInterval,
        },
        worker: {
          pools,
        },
        ...
        <Card title="Configuration" loading={configQuery.isLoading}>
          <Form form={form} layout="vertical" onFinish={submit}>
            ...
            <Row gutter={16}>
              ...
              <Col xs={24} md={12}>
                <Form.Item label="Status Report Interval(s)" name="statusReportInterval" rules={[{ required: true }]}>
